...
public class Main {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		while(true) {
			...
			System.out.println();
			System.out.println("Type the first column of the card you want to pick: ");
			int y1 = input.nextInt()-1;
			System.out.println("Type the first row of the card you want to pick: ");
			int x1 = input.nextInt()-1;
			Card first = matrix.get(y1).get(x1);
			...
			System.out.println();
			System.out.println("Type the second column of the card you want to pick: ");
			int y2 = input.nextInt()-1;
			System.out.println("Type the second row of the card you want to pick: ");
			int x2 = input.nextInt()-1;
			Card second = matrix.get(y2).get(x2);
			second.setChosen(true);
			
			//Print card arrangement with both cards
			System.out.println();
			System.out.printf("     ");
			for(int j = 1; j < size+1; j++) {
				System.out.printf("%3s", j);
